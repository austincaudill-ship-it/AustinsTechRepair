/* ============================================================
   ...
   Smart knowledge-based assistant for customer inquiries
   ============================================================ */
...
(function () {
  ...
  function buildWidget() {
    ...
    bubble.innerHTML = '<i class="fas fa-comments"></i><span class="chat-bubble-badge" style="display:none">1</span>';
  ...
  function openChat() {
    ...
    document.querySelector('.chat-bubble').classList.add('hidden-bubble');
    isOpen = true;
    if (!hasGreeted) {
      hasGreeted = true;
      setTimeout(() => {
        addBotMessage("Hi there! Welcome to Austin's Tech Repair Group. I'm your virtual assistant. How can I help you today?");
  ...
  function closeChat() {
    ...
    document.querySelector('.chat-bubble').classList.remove('hidden-bubble');
    isOpen = false;
  }
  ...
  function showQuickReplies(replies) {
    ...
    wrapper.className = 'chat-message quick-replies';
    const grid = document.createElement('div');
    grid.className = 'chat-quick-grid';
  ...
  function processMessage(text) {
    ...
    setTimeout(() => {
      ...
      if (bestMatch && bestScore > 0) {
        ...
        // Fallback response
        const fallbacks = [
          "That's a great question! I'd recommend calling us at 513-478-8077 or using the Contact page for more specific help. In the meantime, you can also start a repair request using our Repair Wizard on the Repair page.",
          "I'm not sure about that one, but our team can help! Give us a call at 513-478-8077 or visit our Contact page. You can also check the Repair page for instant estimates.",
          "Hmm, I don't have that info on hand. But you can reach our team at 513-478-8077 or send a message through the Contact page. Want me to help with something else like repair pricing or hours?"
        ];
        addBotMessage(fallbacks[Math.floor(Math.random() * fallbacks.length)]);
        showQuickReplies(QUICK_REPLIES.slice(0, 3));
      }
    }, 600 + Math.random() * 600);
  }
